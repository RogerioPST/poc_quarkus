...
public class Task {
	...
	public Task(String description, LocalDateTime reminder, Boolean complete) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(description, task.description) && Objects.equals(reminder, task.reminder)
